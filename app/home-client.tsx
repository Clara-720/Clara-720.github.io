    ...
    <>
      ...
      <main id="main">
        <section className="hero" id="top" aria-labelledby="hero-title">
          <div className="hero-copy"><p className="eyebrow">{t.hero.eyebrow}</p><h1 id="hero-title">{t.hero.title}</h1><p className="hero-role">{t.hero.role}</p><p className="hero-intro">{t.hero.intro}</p><div className="hero-actions"><a className="button button-primary" href="https://clara-720.github.io/cinematic-emotion-map-research/" target="_blank" rel="noreferrer">{t.hero.projectCta}<span aria-hidden="true">↗</span></a><span className="button button-secondary button-disabled" aria-disabled="true">{t.hero.resumeCta}<span aria-hidden="true">—</span></span><a className="button button-tertiary" href="#contact">{t.hero.contactCta}</a></div><a className="hero-email" href="mailto:Mingjing.Hou@outlook.com">Mingjing.Hou@outlook.com</a></div>
